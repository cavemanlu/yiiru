...
/**
 * Класс CListIterator реализует итератор для класса {@link CList}.
 *
 * Позволяет экземпляру класса CList возвращать новый итератор для обхода элементов списка.
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
